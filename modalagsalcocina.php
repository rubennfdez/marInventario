<!-- Modal Salida Cocina-->
<div class="modal fade" id="MSCocina" tabindex="-1" aria-labelledby="MSCocinaLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <!-- Icono para agregar nueva salida -->
                <img src="vistas/iconos/png/exit.png" alt="Icono de nueva salida" class="icon">
                <h1 class="modal-title fs-1" id="MSCocinaLabel">AGREGAR NUEVA SALIDA</h1>
            ...
            <div class="modal-body">
                ...
                <form action="guardasalidac.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="inicialsalidac" id="inicialsalidac" required oninput="validarSalida(this, 'numMensaje')">

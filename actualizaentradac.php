...
// Calcular el totoal sumando los días de la semana
$total = $inicialEC + $lunes + $martes + $miercoles + $jueves + $viernes + $sabado + $domingo;

// Preparar la consulta SQL
$sql = "UPDATE entrada_cocina SET 
        id_categoria_cocina = '$categoria', 
        id_producto_cocina = '$producto',
        id_unidadm_cocina = '$medida', 
        inicial_cocina = '$inicialEC', 
        lunes = '$lunes', 
        martes = '$martes', 
        miercoles = '$miercoles', 
        jueves = '$jueves', 

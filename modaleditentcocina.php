<!-- Modal Editar -->
<div class="modal fade" id="editaECocina" tabindex="-1" aria-labelledby="EditaECLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-header-edit">
                ...
                <h1 class="modal-title fs-1" id="EditaECLabel">EDITAR REGISTRO</h1>
            ...
            <div class="modal-body">
                ...
                <form action="actualizaentradac.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="inicialentradac" id="inicialentradac" class="form-control" required oninput="validarEntrada(this, 'numMensaje')">
...
<script>
    let editaModalEC = document.getElementById('editaECocina');
    editaModalEC.addEventListener('shown.bs.modal', event => {
        ...
        fetch(url, {
            ...
            .then(data => {
                inputId.value = data.idcocina_entrada;

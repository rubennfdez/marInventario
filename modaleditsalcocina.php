<!-- Modal Editar -->
<div class="modal fade" id="editaSCocina" tabindex="-1" aria-labelledby="EditaSCLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-header-edit">
                ...
                <!-- Icono para EDITAR la salida -->
                <img src="vistas/iconos/png/edit.png" alt="Icono de editar salida" class="icon-edit">
                <h1 class="modal-title fs-1" id="EditaSCLabel">EDITAR REGISTRO</h1>
            ...
            <div class="modal-body">
                ...
                <form action="actualizasalidac.php" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Cantidad de inicio en salida -->
                    <div class="mb-3">
                        <label for="inicialsalidac" class="form-label">VALOR INICIAL:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <!-- Ícono de cantidad -->
                            ...
                            <input type="text" name="inicialsalidac" id="inicialsalidac" class="form-control" required oninput="validarSalida(this, 'numMensaje')">
                            <span id="numMensaje" class="text-danger"></span>
                        </div>
                    </div>

                    <!-- Título "Salida por días de la semana" -->
                    <h4 class="text-center-bold">SALIDAS POR DÍAS DE LA SEMANA</h4>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="lunes" id="lunes" class="form-control salida-semana" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="martes" id="martes" class="form-control salida-semana" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="miercoles" id="miercoles" class="form-control salida-semana" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="jueves" id="jueves" class="form-control salida-semana" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="viernes" id="viernes" class="form-control salida-semana" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="sabado" id="sabado" class="form-control salida-semana" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="domingo" id="domingo" class="form-control salida-semana" required>
...
<link rel="stylesheet" href="vistas/css/modalagsalcocina.css">
<script src="vistas/js/modalagsalcocina.js"></script>

<!-- Script para cargar datos en el formulario de edición -->
<script>
    let editaModalSC = document.getElementById('editaSCocina');
    editaModalSC.addEventListener('shown.bs.modal', event => {
        ...
        fetch(url, {
            ...
            .then(data => {
                inputId.value = data.idcocina_salida;

// Elimina todos los registros de la tabla COCINA
function eliminarTodosCocina(e) {
    e.preventDefault();
    var url = e.currentTarget.getAttribute('href');
    // Muestra una confirmación antes de eliminar
    Swal.fire({
        title: '¿Está seguro?',
        text: '¡Todos los registros de la tabla COCINA serán eliminados!',
        icon: 'warning',
...
function mostrarNotificacion() {
    Swal.fire({
        title: '',
        html: "<div class='custom-content'><div class='custom-content-wrapper'><img src='vistas/iconos/svg/check2.svg' class='custom-checkmark' alt='checkmark'><span class='custom-title-class'>Hecho:</span><span class='custom-content-class'>Tabla 'Cocina' eliminada!</span></div></div>",
        position: 'top-end',
        timer: 3000,

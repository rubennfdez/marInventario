<!-- Modal Editar -->
<div class="modal fade" id="editaEBodega" tabindex="-1" aria-labelledby="EditaEBLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-header-edit">
                ...
                <h1 class="modal-title fs-1" id="EditaEBLabel">EDITAR REGISTRO DE ENTRADA</h1>
                ...
                <form action="actualiza.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="entradab" id="entradab" class="form-control" required oninput="validarEntrada(this, 'numMensaje')">
...
<script>
    let editaModal = document.getElementById('editaEBodega');
    editaModal.addEventListener('shown.bs.modal', event => {
        ...
        fetch(url, {
            ...
            .then(data => {
                inputId.value = data.idbodega_entrada;

<!-- Modal Editar -->
<div class="modal fade" id="editaSBodega" tabindex="-1" aria-labelledby="EditaSBLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header modal-header-edit">
                ...
                <h1 class="modal-title fs-1" id="EditaSBLabel">EDITAR REGISTRO SALIDA</h1>
            ...
            <div class="modal-body">
                ...
                <form action="actualizasalida.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="inicialb" class="form-label">VALOR INICIAL:</label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <!-- Ícono de cantidad -->
                            ...
                            <input type="text" name="inicialb" id="inicialb" class="form-control" required oninput="validarSalida(this, 'numMensaje')">
...
<link rel="stylesheet" href="vistas/css/modalagsalbodega.css">
<script src="vistas/js/modalagsalbodega.js"></script>

<!-- Script para cargar datos en el formulario de edición -->
<script>
    let editaModalS = document.getElementById('editaSBodega');
    editaModalS.addEventListener('shown.bs.modal', event => {
        ...
        fetch(url, {
            ...
            .then(data => {
                inputId.value = data.idbodega_salida;

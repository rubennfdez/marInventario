...
// Calcular el actual restando las salidas de cada día
$actual = $inicial - $lunes - $martes - $miercoles - $jueves - $viernes - $sabado - $domingo;

// Preparar la consulta SQL
$sql = "UPDATE salida_bodega SET 
        id_categoria_sbodega = '$categoria', 
        id_producto_sbodega = '$producto',
        id_unidadm_sbodega = '$medida', 
        inicial = '$inicial', 
        lunes = '$lunes', 
        martes = '$martes', 
        miercoles = '$miercoles', 

<!-- Modal Salida Bodega-->
<div class="modal fade" id="MSBodega" tabindex="-1" aria-labelledby="MSBodegaLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h1 class="modal-title fs-1" id="MSBodegaLabel">AGREGAR NUEVA SALIDA</h1>
            ...
            <div class="modal-body">
                ...
                <form action="guardasalida.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="inicialb" id="inicialb" required oninput="validarSalida(this, 'numMensaje')">
